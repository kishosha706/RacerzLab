...
const CHANNEL_META: Record<string, ChannelUiMeta> = {
  ...
  steering_deg: { label: "Steering", unit: "deg", isProxy: false, isEstimate: false, category: "controls", precision: 1 },
  abs_steering_deg: { label: "|Steering|", unit: "deg", isProxy: false, isEstimate: false, category: "controls", precision: 1 },
  abs_lat_accel: { label: "|Lat Accel|", unit: "m/s^2", isProxy: false, isEstimate: false, category: "controls", precision: 2 },
  ...
  dynamic_grade_deg: { label: "Grade", unit: "deg", isProxy: true, isEstimate: true, category: "grade", precision: 1,
    warning: "Estimated from acceleration vs speed derivative, not surveyed elevation." },
  grade_context_label: { label: "Grade Context", unit: "", isProxy: true, isEstimate: true, category: "grade", precision: 0 },
  grade_corrected_long_accel_mps2: { label: "Grade-Corrected Long Accel", unit: "m/s^2", isProxy: true, isEstimate: true, category: "grade", precision: 2 },
  ...
  lf_ride_height_mm: { label: "LF Ride Height", unit: "mm", isProxy: false, isEstimate: false, category: "platform", precision: 1 },
  rf_ride_height_mm: { label: "RF Ride Height", unit: "mm", isProxy: false, isEstimate: false, category: "platform", precision: 1 },
  lr_ride_height_mm: { label: "LR Ride Height", unit: "mm", isProxy: false, isEstimate: false, category: "platform", precision: 1 },
  rr_ride_height_mm: { label: "RR Ride Height", unit: "mm", isProxy: false, isEstimate: false, category: "platform", precision: 1 },
  ...
  platform_pitch_deg_from_rh: { label: "Platform Pitch", unit: "deg", isProxy: true, isEstimate: true, category: "platform", precision: 2,
    warning: "Estimate from ride heights - assumes 1:1 motion ratio." },
  platform_roll_deg_from_rh: { label: "Platform Roll", unit: "deg", isProxy: true, isEstimate: true, category: "platform", precision: 2,
    warning: "Estimate from ride heights - assumes 1:1 motion ratio." },
  front_platform_roll_deg_from_rh: { label: "Front Roll", unit: "deg", isProxy: true, isEstimate: true, category: "platform", precision: 2 },
  rear_platform_roll_deg_from_rh: { label: "Rear Roll", unit: "deg", isProxy: true, isEstimate: true, category: "platform", precision: 2 },
  platform_roll_balance_deg: { label: "Roll Balance", unit: "deg", isProxy: true, isEstimate: true, category: "platform", precision: 2 },
  ...
  ackermann_steering_expected_deg: { label: "Ackermann Expected", unit: "deg", isProxy: true, isEstimate: true, category: "scrub", precision: 2 },
  ackermann_steering_error_deg: { label: "Ackermann Error", unit: "deg", isProxy: true, isEstimate: true, category: "scrub", precision: 2 },
  ...
  front_wheel_speed_mismatch: { label: "Front Wheel Mismatch", unit: "m/s", isProxy: false, isEstimate: false, category: "scrub", precision: 2 },
  rear_wheel_speed_mismatch: { label: "Rear Wheel Mismatch", unit: "m/s", isProxy: false, isEstimate: false, category: "scrub", precision: 2 },
  front_wheel_speed_mismatch_raw: { label: "Front Mismatch (raw)", unit: "m/s", isProxy: false, isEstimate: false, category: "scrub", precision: 2 },
  rear_wheel_speed_mismatch_raw: { label: "Rear Mismatch (raw)", unit: "m/s", isProxy: false, isEstimate: false, category: "scrub", precision: 2 },
  ...
  // -- Tires --
  lf_pressure: { label: "LF Pressure", unit: "kPa", isProxy: false, isEstimate: false, category: "tires", precision: 1 },
  rf_pressure: { label: "RF Pressure", unit: "kPa", isProxy: false, isEstimate: false, category: "tires", precision: 1 },
  lr_pressure: { label: "LR Pressure", unit: "kPa", isProxy: false, isEstimate: false, category: "tires", precision: 1 },
  rr_pressure: { label: "RR Pressure", unit: "kPa", isProxy: false, isEstimate: false, category: "tires", precision: 1 },
  ...
  lf_wear_spread: { label: "LF Wear Spread", unit: "%", isProxy: true, isEstimate: true, category: "tires", precision: 2 },
  ...
  lf_shock_static_defl_in: { label: "LF Shock Static", unit: "in", isProxy: false, isEstimate: true, category: "shocks", precision: 3 },
  rf_shock_static_defl_in: { label: "RF Shock Static", unit: "in", isProxy: false, isEstimate: true, category: "shocks", precision: 3 },
  lr_shock_static_defl_in: { label: "LR Shock Static", unit: "in", isProxy: false, isEstimate: true, category: "shocks", precision: 3 },
  rr_shock_static_defl_in: { label: "RR Shock Static", unit: "in", isProxy: false, isEstimate: true, category: "shocks", precision: 3 },
  lf_shock_defl_delta_in: { label: "LF Shock Delta", unit: "in", isProxy: false, isEstimate: true, category: "shocks", precision: 3 },
  rf_shock_defl_delta_in: { label: "RF Shock Delta", unit: "in", isProxy: false, isEstimate: true, category: "shocks", precision: 3 },
  lr_shock_defl_delta_in: { label: "LR Shock Delta", unit: "in", isProxy: false, isEstimate: true, category: "shocks", precision: 3 },
  rr_shock_defl_delta_in: { label: "RR Shock Delta", unit: "in", isProxy: false, isEstimate: true, category: "shocks", precision: 3 },
