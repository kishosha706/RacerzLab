  ...
  switch (action.type) {
    ...
    case "FOCUS_EVIDENCE": {
      ...
      return {
        ...
        selectedCaseId: ev.caseId ?? null,
        selectedCaseRevision: ev.caseRevision ?? null,
        selectedCaseSha256: ev.caseSha256 ?? null,
        selectedMechanismIds: ev.mechanismIds ?? [],
        selectedResponseRelationId: ev.responseRelationId ?? null,
        selectedComponentIds: ev.componentIds ?? [],
        selectedEffectIds: ev.effectIds ?? [],
        selectedControlKeys: ev.controlKeys ?? [],
